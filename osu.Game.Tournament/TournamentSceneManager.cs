                    ...
                    Children = new Drawable[]
                    {
                        ...
                        buttons = new FillFlowContainer
                        {
                            ...
                            Children = new Drawable[]
                            {
                                ...
                                new Separator(),
                                new ScreenButton(typeof(ScheduleScreen), Key.F1) { Text = "Schedule", RequestSelection = SetScreen },
                                new ScreenButton(typeof(LadderScreen), Key.F2) { Text = "Bracket", RequestSelection = SetScreen },
                                new Separator(),
                                new ScreenButton(typeof(TeamIntroScreen), Key.F3) { Text = "Team Intro", RequestSelection = SetScreen },
                                new ScreenButton(typeof(SeedingScreen), Key.F4) { Text = "Seeding", RequestSelection = SetScreen },
                                new Separator(),
                                /* Append new screen "board" for board display */
                                new ScreenButton(typeof(BoardScreen), Key.F5) { Text = "Board", RequestSelection = SetScreen },
                                new ScreenButton(typeof(EXBoardScreen), Key.F6) { Text = "EX Stage", RequestSelection = SetScreen },
                                new ScreenButton(typeof(MapPoolScreen), Key.F7) { Text = "Map Pool", RequestSelection = SetScreen },
                                new ScreenButton(typeof(GameplayScreen), Key.F8) { Text = "Gameplay", RequestSelection = SetScreen },
                                new Separator(),
                                new ScreenButton(typeof(TeamWinScreen), Key.F9) { Text = "Win", RequestSelection = SetScreen },
                                new Separator(),
