...
namespace osu.Game.Tournament.Models
{
    ...
    public class TournamentRound
    {
        ...
        public readonly BindableInt ProtectCount = new BindableInt { Default = 0, MinValue = 0, MaxValue = 3 };
        public readonly BindableBool AllowPickOpponentProtect = new BindableBool(true);
