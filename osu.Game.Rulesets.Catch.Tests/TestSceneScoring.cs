...
namespace osu.Game.Rulesets.Catch.Tests
{
    ...
    public partial class TestSceneScoring : ScoringTestScene
    {
        ...
        private class CatchProcessorBasedScoringAlgorithm : ProcessorBasedScoringAlgorithm
        {
            ...
            protected override Judgement CreatePerfectJudgementResult() => new CatchJudgement(new Fruit(), new CatchJudgementInfo()) { Type = HitResult.Great };
            ...
            protected override Judgement CreateMissJudgementResult() => new CatchJudgement(new Fruit(), new CatchJudgementInfo()) { Type = HitResult.Miss };
        }
    }
}
