...
namespace osu.Game.Rulesets.Tau.Mods
{
    public class TauModBlinds : Mod, IApplicableToDrawableRuleset<TauHitObject>, IApplicableToHealthProcessor
    {
        ...
        /// <summary>
        /// Element for the Blinds mod drawing 2 blind panels covering the whole screen which resize inside a restricted area with some leniency.
        /// </summary>
        public class DrawableTauBlinds : Container
        {
            /// <summary>
            ...
            private readonly Beatmap<TauHitObject> beatmap;
