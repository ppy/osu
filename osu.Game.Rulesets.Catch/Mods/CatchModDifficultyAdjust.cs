...
namespace osu.Game.Rulesets.Catch.Mods
{
    ...
    {
        [SettingSource("圆圈大小", "覆盖谱面的CS设置", FIRST_SETTING_ORDER - 1, SettingControlType = typeof(DifficultyAdjustSettingsControl))]
        ...
        [SettingSource("降落速度", "覆盖谱面的AR设置", LAST_SETTING_ORDER + 1, SettingControlType = typeof(DifficultyAdjustSettingsControl))]
