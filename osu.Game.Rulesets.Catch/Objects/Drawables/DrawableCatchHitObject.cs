...
namespace osu.Game.Rulesets.Catch.Objects.Drawables
{
    public abstract partial class DrawableCatchHitObject : DrawableHitObject<CatchHitObject>
    {
        ...
        protected override Judgement CreateResult(JudgementCriteria judgementCriteria) => new CatchJudgement(HitObject, judgementCriteria);
        ...
        protected override void CheckForResult(bool userTriggered, double timeOffset)
        {
            ...
            if (timeOffset >= 0 && Result != null)
                ApplyResult(r => r.Type = CheckPosition.Invoke(HitObject) ? r.JudgementCriteria.MaxResult : r.JudgementCriteria.MinResult);
        }
