...
namespace osu.Game.Rulesets.Taiko.Tests
{
    ...
    public partial class TestSceneHits : DrawableTaikoRulesetTestScene
    {
        ...
        private void addHitJudgement(bool kiai)
        {
            ...
            ((TaikoPlayfield)DrawableRuleset.Playfield).OnNewResult(h, new Judgement(hit, new TaikoJudgementInfo()) { Type = hitResult });
        }
        ...
        private void addStrongHitJudgement(bool kiai)
        {
            ...
            ((TaikoPlayfield)DrawableRuleset.Playfield).OnNewResult(h, new Judgement(hit, new TaikoJudgementInfo()) { Type = hitResult });
            ((TaikoPlayfield)DrawableRuleset.Playfield).OnNewResult(h.NestedHitObjects.Single(), new Judgement(hit.NestedHitObjects.Single(), new TaikoStrongJudgementInfo()) { Type = HitResult.Great });
        }
        ...
        private void addMissJudgement()
        {
            ...
            ((TaikoPlayfield)DrawableRuleset.Playfield).OnNewResult(h, new Judgement(h.HitObject, new TaikoJudgementInfo()) { Type = HitResult.Miss });
        }
