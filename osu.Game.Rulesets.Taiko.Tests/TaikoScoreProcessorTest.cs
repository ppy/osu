...
namespace osu.Game.Rulesets.Taiko.Tests
{
    ...
    public class TaikoScoreProcessorTest
    {
        ...
        public void TestInaccurateHitScore()
        {
            ...
            scoreProcessor.ApplyResult(new Judgement(beatmap.HitObjects[0], new TaikoJudgementInfo()) { Type = HitResult.Great });
            scoreProcessor.ApplyResult(new Judgement(beatmap.HitObjects[1], new TaikoJudgementInfo()) { Type = HitResult.Ok });
