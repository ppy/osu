...
namespace osu.Game.Rulesets.Osu.Tests.Mods
{
    ...
    {
        [Test]
        public void TestInputAtIntroAlternate() => CreateModTest(new ModTestData
        {
            Mod = new OsuModTapBlocking(),
        ...
        [Test]
        public void TestInputAtIntroSingleTap() => CreateModTest(new ModTestData
        {
            Mod = new OsuModTapBlocking { SingleTap = { Value = true }, Alternate = { Value = false }},
            PassCondition = () => Player.ScoreProcessor.Combo.Value == 1,
            Autoplay = false,
            Beatmap = new Beatmap
            {
        ...
        [Test]
        public void TestInputAlternatingAlternate() => CreateModTest(new ModTestData
        {
            Mod = new OsuModTapBlocking(),
        ...
        [Test]
        public void TestInputAlternatingSingleTap() => CreateModTest(new ModTestData
        {
            Mod = new OsuModTapBlocking { SingleTap = { Value = true}, Alternate = {Value = false}},
            PassCondition = () => Player.ScoreProcessor.Combo.Value == 1,
            Autoplay = false,
        ...
        [Test]
        public void TestInputSingularAlternate() => CreateModTest(new ModTestData
        {
            Mod = new OsuModTapBlocking(),
        ...
        [Test]
        public void TestInputSingularSingleTap() => CreateModTest(new ModTestData
        {
            Mod = new OsuModTapBlocking { SingleTap = { Value = true}, Alternate = {Value = false}},
            PassCondition = () => Player.ScoreProcessor.HighestCombo.Value == 2,
            Autoplay = false,
            Beatmap = new Beatmap
            {
                HitObjects = new List<HitObject>
        ...
        [Test]
        public void TestInputSingularWithBreakAlternate() => CreateModTest(new ModTestData
        {
            Mod = new OsuModTapBlocking(),
            PassCondition = () => Player.ScoreProcessor.Combo.Value == 1,
            Autoplay = false,
        ...
        [Test]
        public void TestInputSingularWithBreakSingleTap() => CreateModTest(new ModTestData
        {
            Mod = new OsuModTapBlocking { SingleTap = { Value = true}, Alternate = {Value = false}},
