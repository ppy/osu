...
namespace osu.Game.Rulesets.Osu.Tests
{
    public partial class TestSceneSpinnerJudgement : RateAdjustedBeatmapTestScene
    {
        ...
        public void TestHitNothing()
        {
            ...
            AddAssert("all min judgements", () => judgementResults.All(result => result.Type == result.JudgementInfo.MinResult));
        }
        ...
        public void TestHitEverything()
        {
            ...
            AddAssert("all max judgements", () => judgementResults.All(result => result.Type == result.JudgementInfo.MaxResult));
        }
