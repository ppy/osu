...
namespace osu.Game.Rulesets.Osu.Tests
{
    ...
    public partial class TestSceneScoring : ScoringTestScene
    {
        ...
        private class OsuProcessorBasedScoringAlgorithm : ProcessorBasedScoringAlgorithm
        {
            ...
            protected override Judgement CreatePerfectJudgementResult() => new OsuJudgement(new HitCircle(), new OsuJudgementInfo()) { Type = HitResult.Great };
            protected override Judgement CreateNonPerfectJudgementResult() => new OsuJudgement(new HitCircle(), new OsuJudgementInfo()) { Type = HitResult.Ok };
            protected override Judgement CreateMissJudgementResult() => new OsuJudgement(new HitCircle(), new OsuJudgementInfo()) { Type = HitResult.Miss };
        }
    }
}
