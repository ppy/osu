...
namespace M.DBus.Tray
{
    ...
    public class SimpleEntry
    {
        ...
        /// </summary>
        public string Type { get; set; } = EntryType.SStandard;
        ...
        /// 图标的 PNG 数据。
        /// </summary>
        public byte[] IconData { get; set; } = EmptyPngBytes;
        ...
        /// [["Control", "Q"], ["Alt", "X"]]<br/>
        /// </summary>
        public IList<string[]> Shortcuts { get; set; } = new List<string[]>();
        ...
        /// - "": 项目不能切换
        /// </summary>
        public string ToggleType { get; set; } = Utils.Canonical.DBusMenuFlags.ToggleType.SIndependentToggleable;
        ...
        /// </summary>
        public string ChildrenDisplay { get; set; } = ChildrenDisplayType.SNone;
