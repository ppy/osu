...
namespace osu.Game.Tests.Rulesets.Scoring
{
    public partial class ScoreProcessorTest
    {
        ...
        [TestCase(ScoringMode.Classic, HitResult.Meh, 8_378)]
        [TestCase(ScoringMode.Classic, HitResult.Ok, 16_992)]
        [TestCase(ScoringMode.Classic, HitResult.Great, 102_131)]
        ...
        [TestCase(ScoringMode.Classic, HitResult.Meh, HitResult.Great, 3_512)]
        [TestCase(ScoringMode.Classic, HitResult.Ok, HitResult.Great, 7_113)]
        [TestCase(ScoringMode.Classic, HitResult.Good, HitResult.Perfect, 15_885)]
        [TestCase(ScoringMode.Classic, HitResult.Great, HitResult.Great, 34_162)]
        [TestCase(ScoringMode.Classic, HitResult.Perfect, HitResult.Perfect, 34_162)]
