...
namespace osu.Game.Tests.Rulesets.Scoring
{
    public partial class ScoreProcessorTest
    {
        ...
        public void TestSingleOsuHit(ScoringMode scoringMode, HitResult hitResult, int expectedScore)
        {
            ...
            var judgementResult = new Judgement(beatmap.HitObjects.Single(), new OsuJudgementInfo())
            {
                Type = hitResult
            };
        ...
        {
            var minResult = new TestJudgementInfo(hitResult).MinResult;
        ...
        {
            Assert.AreEqual(expectedMinResult, new TestJudgementInfo(hitResult).MinResult);
        }
...
#pragma warning restore CS0618
        ...
        public void TestAccuracyUpdateFromIgnoreMiss(HitResult maxResult)
        {
            ...
            var judgementResult = new Judgement(beatmap.HitObjects.Single(), new TestJudgementInfo(maxResult, HitResult.IgnoreMiss))
            {
        ...
        private class TestJudgementInfo : JudgementInfo
        {
            ...
            public TestJudgementInfo(HitResult maxResult, HitResult? minResult = null)
            {
                MaxResult = maxResult;
        ...
        private class TestHitObject : HitObject
        {
            ...
            public override JudgementInfo CreateJudgement()
            {
                return new TestJudgementInfo(maxResult, minResult);
            }
