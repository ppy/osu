...
namespace osu.Game.Tests.Gameplay
{
    ...
    public partial class TestSceneScoreProcessor : OsuTestScene
    {
        ...
        public void TestNoScoreIncreaseFromMiss()
        {
            ...
            scoreProcessor.ApplyResult(new Judgement(new HitObject(), new TestJudgementCriteria()) { Type = HitResult.Miss });
        ...
        public void TestOnlyBonusScore()
        {
            ...
            // Apply a judgement
            scoreProcessor.ApplyResult(new Judgement(new HitObject(), new TestJudgementCriteria(HitResult.LargeBonus)) { Type = HitResult.LargeBonus });
        ...
        public void TestResetFromReplayFrame()
        {
            ...
            scoreProcessor.ApplyResult(new Judgement(beatmap.HitObjects[0], new TestJudgementCriteria(HitResult.Great)) { Type = HitResult.Great });
        ...
        private class TestJudgementCriteria : JudgementCriteria
        {
            ...
            public TestJudgementCriteria(HitResult maxResult = HitResult.Perfect)
            {
                MaxResult = maxResult;
            }
        }
