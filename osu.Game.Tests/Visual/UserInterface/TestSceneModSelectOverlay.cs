...
namespace osu.Game.Tests.Visual.UserInterface
{
    ...
    public partial class TestSceneModSelectOverlay : OsuManualInputManagerTestScene
    {
        ...
        public void TestModMultiplierUpdates()
        {
            ...
            AddAssert("difficulty multiplier display shows correct value", () => modSelectOverlay.ChildrenOfType<ScoreMultiplierDisplay>().Single().Current.Value, () => Is.EqualTo(0.05));
            ...
            AddUntilStep("difficulty multiplier display shows correct value", () => modSelectOverlay.ChildrenOfType<ScoreMultiplierDisplay>().Single().Current.Value, () => Is.EqualTo(0.3));
        }
