...
namespace osu.Game.Tests.Visual.UserInterface
{
    public partial class TestSceneButtonsInput : OsuManualInputManagerTestScene
    {
        ...
        public void TestSettingsButtonInput()
        {
            ...
            AddStep("Move cursor to padded area", () => InputManager.MoveMouseTo(settingsButton.ScreenSpaceDrawQuad.TopLeft + new Vector2(SettingsPanel.ContentPaddingV2.Left / 2f, 10)));
