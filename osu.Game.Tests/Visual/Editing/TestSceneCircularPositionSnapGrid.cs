...
{
    public partial class TestSceneCircularPositionSnapGrid : OsuManualInputManagerTestScene
    {
        ...
        public void TestCircularGrid(Vector2 position, float spacing, float rotation)
        {
