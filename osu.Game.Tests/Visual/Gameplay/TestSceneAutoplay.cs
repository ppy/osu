...
namespace osu.Game.Tests.Visual.Gameplay
{
    ...
    public partial class TestSceneAutoplay : TestSceneAllRulesetPlayers
    {
        ...
        protected override void AddCheckSteps()
        {
            ...
            AddUntilStep("key counter counted keys", () => Player.HUDOverlay.BottomRightKeyCounter.Children.Any(kc => kc.CountPresses > 2));

            seekTo(referenceBeatmap.Breaks[0].StartTime);
            AddAssert("keys not counting", () => !Player.HUDOverlay.BottomRightKeyCounter.IsCounting);
            ...
            AddUntilStep("key counter reset", () => Player.HUDOverlay.BottomRightKeyCounter.Children.All(kc => kc.CountPresses == 0));
