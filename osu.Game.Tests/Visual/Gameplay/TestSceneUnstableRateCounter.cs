...
namespace osu.Game.Tests.Visual.Gameplay
{
    public partial class TestSceneUnstableRateCounter : OsuTestScene
    {
        ...
        public void TestBasic()
        {
            ...
            AddRepeatStep("Revert UR", () =>
            {
                scoreProcessor.RevertResult(
                    new Judgement(new HitCircle { HitWindows = hitWindows }, new JudgementInfo())
                    {
                        GameplayRate = 1.0,
                        TimeOffset = 25,
        ...
        private void applyJudgement(double offsetMs, bool alt, double gameplayRate = 1.0)
        {
            ...
            scoreProcessor.ApplyResult(new Judgement(new HitCircle { HitWindows = hitWindows }, new JudgementInfo())
            {
