...
namespace osu.Game.Tests.Visual.Gameplay
{
    public partial class TestSceneGameplayRewinding : OsuPlayerTestScene
    {
        ...
        public void TestNoJudgementsOnRewind()
        {
            ...
            AddUntilStep("key counter counted keys", () => Player.HUDOverlay.BottomRightKeyCounter.Children.Select(kc => kc.CountPresses).Sum() == 15);
            AddStep("clear results", () => Player.Results.Clear());
            addSeekStep(0);
            AddAssert("none judged", () => Player.DrawableRuleset.Playfield.AllHitObjects.All(h => !h.Judged));
            AddUntilStep("key counters reset", () => Player.HUDOverlay.BottomRightKeyCounter.Children.All(kc => kc.CountPresses == 0));
