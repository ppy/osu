...
namespace osu.Game.Tests.Visual
{
    ...
    public class TestCaseBeatmapSetOverlay : OsuTestCase
    {
        ...
        {
            RulesetInfo mania = rulesets.GetRuleset(3);
            RulesetInfo taiko = rulesets.GetRuleset(1);

            AddStep(@"show loading", () => overlay.ShowBeatmapSet(null));

            AddStep(@"show online", () => overlay.FetchAndShowBeatmapSet(55));

            AddStep(@"show first", () => overlay.ShowBeatmapSet(new BeatmapSetInfo
            {
            ...
            AddStep(@"show second", () => overlay.ShowBeatmapSet(new BeatmapSetInfo
            {
                Metadata = new BeatmapMetadata
                {
