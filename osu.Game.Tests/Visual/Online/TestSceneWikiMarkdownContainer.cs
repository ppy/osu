...
---";
        ...
        public void TestAbsoluteImage()
        {
            ...
            {
                markdownContainer.CurrentPath = "https://dev.ppy.sh/wiki/images/Client/Interface/";
...
Line after image";
        ...
        public void TestInlineImage()
        {
            ...
            {
                markdownContainer.CurrentPath = "https://dev.ppy.sh/wiki/shared/";
                markdownContainer.Text = "![osu! mode icon](mode/osu.png) osu!";
            });
        }
...
";
        ...
        public void TestWideImageNotExceedContainer()
        {
            AddStep("Add image", () =>
            {
                markdownContainer.CurrentPath = "https://dev.ppy.sh/wiki/images/Client/Program_files/";
