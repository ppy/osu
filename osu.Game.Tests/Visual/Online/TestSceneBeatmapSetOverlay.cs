...
namespace osu.Game.Tests.Visual.Online
{
    public partial class TestSceneBeatmapSetOverlay : OsuManualInputManagerTestScene
    {
        ...
        public void TestSelectedModsDontAffectStatistics()
        {
            ...
            AddAssert("AR displayed as 0", () => overlay.ChildrenOfType<AdvancedStats.StatisticRow>().Single(s => s.Title == RulesetBeatmapAttributesStrings.ApproachRate).Value, () => Is.EqualTo((0, 0)));
            ...
            AddAssert("AR still displayed as 0", () => overlay.ChildrenOfType<AdvancedStats.StatisticRow>().Single(s => s.Title == RulesetBeatmapAttributesStrings.ApproachRate).Value, () => Is.EqualTo((0, 0)));
        }
