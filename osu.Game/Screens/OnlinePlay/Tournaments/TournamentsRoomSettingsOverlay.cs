...
{
    public partial class TournamentsRoomSettingsOverlay : RoomSettingsOverlay
    {
        public Action? EditTournament;
        ...
        public TournamentsRoomSettingsOverlay(Room room)
            : base(room)
        {
        }
        ...
        protected override Drawable CreateSettings(Room room) => settings = new MatchSettings(room)
        {
            ...
            EditTournament = () => EditTournament?.Invoke()
        };
