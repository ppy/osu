...
{
    public class EditorDropdown<T> : Dropdown<T>, IHasAccentColour // This is an actual copy of OsuDropdown, only because it has a different height than the one used in OsuDropdown
    {
