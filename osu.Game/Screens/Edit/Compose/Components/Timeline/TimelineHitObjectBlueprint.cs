...
namespace osu.Game.Screens.Edit.Compose.Components.Timeline
{
    public class TimelineHitObjectBlueprint : SelectionBlueprint<HitObject>
    {
        ...
        protected override void Update()
        {
            ...
            if (Item.LocalDifficultyControlPoint != difficultyOverrideDisplay?.DifficultyPoint)
            {
                difficultyOverrideDisplay?.Expire();
                if (Item.LocalDifficultyControlPoint != null)
                    AddInternal(difficultyOverrideDisplay = new DifficultyPointPiece(Item.LocalDifficultyControlPoint));
            }

            if (Item.LocalSampleControlPoint != sampleOverrideDisplay?.SamplePoint)
            {
                sampleOverrideDisplay?.Expire();
                if (Item.LocalSampleControlPoint != null)
                    AddInternal(sampleOverrideDisplay = new SamplePointPiece(Item.LocalSampleControlPoint));
            }
        }
