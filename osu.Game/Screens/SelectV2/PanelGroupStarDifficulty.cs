...
{
    public partial class PanelGroupStarDifficulty : Panel, IHasContextMenu
    {
        ...
        public MenuItem[] ContextMenuItems
        {
            get
            {
                ...
                return new MenuItem[]
                {
                    new OsuMenuItem(Expanded.Value ? "Collapse" : "Expand", MenuItemType.Highlighted, () => Carousel?.Activate(Item)),
                };
            }
        }
    }
