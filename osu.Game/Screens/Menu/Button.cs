...
namespace osu.Game.Screens.Menu
{
    ...
    /// </summary>
    public class Button : BeatSyncedContainer, IStateful<ButtonState>, IHandleOnHover, IHandleOnHoverLost, IHandleOnMouseDown, IHandleOnMouseUp, IHandleOnClick, IHandleOnKeyDown
    {
