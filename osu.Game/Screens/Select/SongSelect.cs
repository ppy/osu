...
namespace osu.Game.Screens.Select
{
    public abstract class SongSelect : OsuScreen, IKeyBindingHandler<GlobalAction>
    {
        ...
        {
            BeatmapInfo recommended = recommender.GetRecommendedBeatmap(beatmap.BeatmapSet.Beatmaps);
            double? recommendedStarDifficulty = recommender.GetRecommendedStarDifficulty();
