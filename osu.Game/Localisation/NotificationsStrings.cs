...
{0}", filename);
        ...
        /// </summary>
        public static LocalisableString UploadSuccess => new TranslatableString(getKey(@"screenshot_upload_success"), @"Screenshot uploaded! The link has been copied to the clipboard.");

        /// <summary>
        /// "Failed to upload screenshot."
        /// </summary>
        public static LocalisableString UploadFailure => new TranslatableString(getKey(@"screenshot_upload_failure"), @"Failed to upload screenshot.");
