...
namespace osu.Game.Localisation
{
    public class RulesetActionStrings
    {
        ...
        /// "Move left"
        /// </summary>
        public static LocalisableString CatchMoveLeft => new TranslatableString(getKey(@"catch_move_left"), @"Move left");
        ...
        /// "Engage dash"
        /// </summary>
        public static LocalisableString CatchDash => new TranslatableString(getKey(@"catch_dash"), @"Engage dash");

        /// <summary>
        /// "Key {0}"
        /// </summary>
        public static LocalisableString ManiaKey(int keyNumber) => new TranslatableString(getKey(@"mania_key"), @"Key {0}", keyNumber);
