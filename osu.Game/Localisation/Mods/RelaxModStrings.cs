...
namespace osu.Game.Localisation.Mods
{
    public static class RelaxModStrings
    {
        ...
        public static LocalisableString OsuDescription =>
            new TranslatableString(getKey(@"osu_description"), "You don't need to click. Give your clicking/tapping fingers a break from the heat of things.");

        /// <summary>
        /// "No ninja-like spinners, demanding drumrolls or unexpected katu's."
        /// </summary>
        public static LocalisableString TaikoDescription => new TranslatableString(getKey(@"taiko_description"), "No ninja-like spinners, demanding drumrolls or unexpected katu's.");
