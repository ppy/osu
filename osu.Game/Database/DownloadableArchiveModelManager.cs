...
namespace osu.Game.Database
{
        ...
        where TFileModel : class, INamedFileInfo, new()
    {
        ...
        protected abstract ArchiveDownloadRequest<TModel> CreateDownloadRequest(TModel model, bool noVideo, bool IsMini);
        ...
        public bool Download(TModel model, bool noVideo = false, bool IsMini = false)
        {
            if (!canDownload(model)) return false;

            var request = CreateDownloadRequest(model, noVideo, IsMini);
