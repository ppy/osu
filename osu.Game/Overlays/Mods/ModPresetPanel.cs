...
namespace osu.Game.Overlays.Mods
{
    public partial class ModPresetPanel : ModSelectPanel, IHasCustomTooltip<ModPreset>, IHasContextMenu, IHasPopover
    {
        ...
        {
            new OsuMenuItem(LocalisableString.Interpolate($@"{CommonStrings.ButtonsEdit}..."), MenuItemType.Highlighted, this.ShowPopover),
            new OsuMenuItem(LocalisableString.Interpolate($@"{CommonStrings.ButtonsDelete}..."), MenuItemType.Destructive, () => dialogOverlay?.Push(new DeleteModPresetDialog(Preset))),
        };
