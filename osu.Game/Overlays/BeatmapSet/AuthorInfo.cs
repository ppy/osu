    ...
    public class AuthorInfo : Container
    {
        ...
        private void updateDisplay()
        {
            ...
            fields.Children = new Drawable[]
            {
                ...
                new Field("提交日期:", online.Submitted.ToString(@"MMMM d, yyyy"), OsuFont.GetFont(weight: FontWeight.Bold))
                {
            ...
            {
                fields.Add(new Field("Rank日期", online.Ranked.Value.ToString(@"MMMM d, yyyy"), OsuFont.GetFont(weight: FontWeight.Bold)));
            }
            else if (online.LastUpdated.HasValue)
            {
                fields.Add(new Field("上次更新:", online.LastUpdated.Value.ToString(@"MMMM d, yyyy"), OsuFont.GetFont(weight: FontWeight.Bold)));
            }
        }
