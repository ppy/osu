...
namespace osu.Game.Overlays.BeatmapSet
{
    public class AuthorInfo : Container
    {
        ...
        private void updateDisplay()
        {
            ...
            {
                new Field("谱师: ", BeatmapSet.Author, OsuFont.GetFont(weight: FontWeight.Regular, italics: true)),
                new Field("提交于", BeatmapSet.Submitted, OsuFont.GetFont(weight: FontWeight.Bold))
                {
            ...
            {
                fields.Add(new Field("上次更新", BeatmapSet.LastUpdated.Value, OsuFont.GetFont(weight: FontWeight.Bold)));
            }
        }
