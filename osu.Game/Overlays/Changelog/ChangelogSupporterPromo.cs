...
namespace osu.Game.Overlays.Changelog
{
    public class ChangelogSupporterPromo : CompositeDrawable
    {
        ...
        private void load(OsuColour colour, TextureStore textures)
        {
            ...
            supportLinkText.AddText("支持osu!的后续开发，");
            supportLinkText.AddLink("成为osu!supporter", "https://osu.ppy.sh/home/support", t => t.Font = t.Font.With(weight: FontWeight.Bold));
            supportLinkText.AddText("吧！");
