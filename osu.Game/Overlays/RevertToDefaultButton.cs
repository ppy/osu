    ...
    public partial class RevertToDefaultButton<T> : OsuClickableContainer, IHasCurrentValue<T>
    {
        ...
        private void updateHover()
        {
            if (IsHovered && Enabled.Value)
            {
                ...
                icon.FadeColour(colourProvider.Light1, 300, Easing.OutQuint);
                circle.FadeColour(colourProvider.Background2, 300, Easing.OutQuint);
            ...
            else
            {
                ...
                icon.FadeColour(colourProvider.Colour0, 100, Easing.OutQuint);
                circle.FadeColour(colourProvider.Background3, 100, Easing.OutQuint);
