...
namespace osu.Game.Overlays.Volume
{
    ...
    {
        public Func<KeyBindingPressEvent<GlobalAction>, bool> ActionRequested;
        public Func<GlobalAction, float, bool, bool> ScrollActionRequested;

        public bool OnPressed(KeyBindingPressEvent<GlobalAction> e) => ActionRequested?.Invoke(e) ?? false;
