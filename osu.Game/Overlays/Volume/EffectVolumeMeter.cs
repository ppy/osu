...
{
    public partial class EffectVolumeMeter : VolumeMeter
    {
        ...
        public EffectVolumeMeter(string name, float circleSize, Color4 meterColour)
        ...
        private void load(AudioManager audio)
        {
            ...
            {
                if (muted.NewValue)
                    audio.Samples.AddAdjustment(AdjustableProperty.Volume, muteAdjustment);
                else
                    audio.Samples.RemoveAdjustment(AdjustableProperty.Volume, muteAdjustment);
            });
