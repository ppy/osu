...
{
    public partial class TrackVolumeMeter : VolumeMeter
    {
        ...
        public TrackVolumeMeter(string name, float circleSize, Color4 meterColour)
        ...
        private void load(AudioManager audio)
        {
            ...
            {
                if (muted.NewValue)
                    audio.Tracks.AddAdjustment(AdjustableProperty.Volume, muteAdjustment);
                else
                    audio.Tracks.RemoveAdjustment(AdjustableProperty.Volume, muteAdjustment);
            });
