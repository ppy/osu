...
{
    public abstract class OverlayStreamControlCN<T> : TabControl<T>
    {
        protected OverlayStreamControlCN()
        {
        ...
        [NotNull]
        protected abstract OverlayStreamItemCN<T> CreateStreamItem(T value);
        ...
        {
            foreach (var streamBadge in TabContainer.Children.OfType<OverlayStreamItemCN<T>>())
