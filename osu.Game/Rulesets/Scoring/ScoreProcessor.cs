...
namespace osu.Game.Rulesets.Scoring
{
    public partial class ScoreProcessor : JudgementProcessor
    {
        ...
        protected sealed override void ApplyResultInternal(Judgement result)
        {
            ...
            if (result.JudgementCriteria.MaxResult.AffectsAccuracy())
            {
                currentMaximumBaseScore += GetBaseScoreForResult(result.JudgementCriteria.MaxResult);
        ...
        /// </summary>
        /// <param name="result">The judgement result.</param>
        protected virtual double GetComboScoreChange(Judgement result) => GetBaseScoreForResult(result.JudgementCriteria.MaxResult) * Math.Pow(result.ComboAfterJudgement, COMBO_EXPONENT);
