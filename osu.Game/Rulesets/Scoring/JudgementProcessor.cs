...
namespace osu.Game.Rulesets.Scoring
{
    public abstract partial class JudgementProcessor : Component
    {
        ...
        /// <summary>
        /// Whether all <see cref="JudgementCriteria"/>s have been processed.
        /// </summary>
...
#pragma warning restore CS0618
        ...
        protected virtual Judgement CreateResult(HitObject hitObject, JudgementCriteria judgementCriteria) => new Judgement(hitObject, judgementCriteria);

        /// <summary>
        /// Gets a simulated <see cref="HitResult"/> for a judgement. Used during <see cref="SimulateAutoplay"/> to simulate a "perfect" play.
        /// </summary>
        /// <param name="judgementCriteria">The judgement to simulate a <see cref="HitResult"/> for.</param>
        /// <returns>The simulated <see cref="HitResult"/> for the judgement.</returns>
        protected virtual HitResult GetSimulatedHitResult(JudgementCriteria judgementCriteria) => judgementCriteria.MaxResult;
