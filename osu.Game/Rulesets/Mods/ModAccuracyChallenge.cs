...
namespace osu.Game.Rulesets.Mods
{
    public class ModAccuracyChallenge : ModFailCondition, IApplicableToScoreProcessor
    {
        ...
        public override LocalisableString Description => FailConditionModsStrings.AccuracyChallengeDescription;
        ...
        [SettingSource(typeof(FailConditionModsStrings), nameof(FailConditionModsStrings.MinAcc), nameof(FailConditionModsStrings.MinAccDescription), SettingControlType = typeof(SettingsSlider<double, PercentSlider>))]
