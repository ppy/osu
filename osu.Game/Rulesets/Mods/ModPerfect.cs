...
namespace osu.Game.Rulesets.Mods
{
    public abstract class ModPerfect : ModFailCondition
    {
        ...
        protected override bool FailCondition(HealthProcessor healthProcessor, Judgement result)
            => (isRelevantResult(result.JudgementInfo.MinResult) || isRelevantResult(result.JudgementInfo.MaxResult) || isRelevantResult(result.Type))
               && result.Type != result.JudgementInfo.MaxResult;
