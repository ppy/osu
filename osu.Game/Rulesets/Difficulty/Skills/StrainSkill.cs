...
namespace osu.Game.Rulesets.Difficulty.Skills
{
    ...
    public abstract class StrainSkill : Skill
    {
        ...
        /// </summary>
        protected abstract double StrainValueAt(PrePerNoteStrainSkill[] preSkills, int index, DifficultyHitObject current);

        /// <summary>
        /// Process a <see cref="DifficultyHitObject"/> and update current strain values accordingly.
        /// </summary>
        protected sealed override void Process(PrePerNoteStrainSkill[] preSkills, int index, DifficultyHitObject current)
        {
