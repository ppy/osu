...
namespace osu.Game.Rulesets.Judgements
{
    ...
    public class Judgement
    {
        ...
        /// <summary>
        /// The <see cref="JudgementInfo"/> which this <see cref="Judgement"/> applies for.
        /// </summary>
        public readonly JudgementInfo JudgementInfo;
        ...
        /// <param name="judgementInfo">The <see cref="JudgementInfo"/> to refer to for scoring information.</param>
        public Judgement(HitObject hitObject, JudgementInfo judgementInfo)
        {
            HitObject = hitObject;
        ...
        public override string ToString() => $"{Type} ({JudgementInfo})";
    }
}
