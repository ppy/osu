...
namespace osu.Game.Skinning
{
    ...
    /// </summary>
    public partial class LegacyBaseComboCounter : CompositeDrawable
    {
        ...
        [SettingSource("Should roll")]
        public virtual BindableBool ShouldRoll { get; } = new BindableBool(true);
        ...
        private string formatCount(int count) => ShouldRoll.Value ? $@"{count}x" : $@"{count}";
