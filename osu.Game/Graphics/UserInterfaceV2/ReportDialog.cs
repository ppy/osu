...
{
    /// <summary>
    /// A generic popup dialog for sending an online report about something.
    /// </summary>
        ...
        where TReportReason : struct, Enum
    {
        ...
        /// Set this to `false` if you're displaying a custom message outside of this dialog.
        /// </param>
        /// <param name="colourProvider">The colour provider to be used by this dialog.</param>
        protected ReportDialog(LocalisableString headerString, bool showConfirmation = true, OverlayColourProvider? colourProvider = null)
        {
            header = headerString;
            this.showConfirmation = showConfirmation;

            // We inject the colour provider manually instead of relying on DI, because it's going
            // to be pushed to a `DialogOverlay` which will have a different dependency container
            // than the overlay/screen this dialog is related to.
            this.colourProvider = colourProvider ?? new OverlayColourProvider(OverlayColourScheme.Plum);
        }
                                ...
                                Children = new Drawable[]
                                {
                                    ...
                                    submitButton = new RoundedButton
                                    {
                                        ...
                                        Action = () =>
                                        {
                                            ...
                                            container.AutoSizeEasing = Easing.OutQuint;
                                            container.AutoSizeDuration = 500F;
