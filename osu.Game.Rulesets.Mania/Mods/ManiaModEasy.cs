...
namespace osu.Game.Rulesets.Mania.Mods
{
    public class ManiaModEasy : ModEasyWithExtraLives, IApplicableToHitObject
    {
        ...
        void IApplicableToHitObject.ApplyToHitObject(HitObject hitObject)
        {
            ...
            {
                case Note:
                    ((ManiaHitWindows)hitObject.HitWindows).DifficultyMultiplier = 1.4;
                    break;

                case HoldNote hold:
                    ((ManiaHitWindows)hold.Head.HitWindows).DifficultyMultiplier = 1.4;
                    ((ManiaHitWindows)hold.Tail.HitWindows).DifficultyMultiplier = 1.4;
                    break;
            }
        }
    }
