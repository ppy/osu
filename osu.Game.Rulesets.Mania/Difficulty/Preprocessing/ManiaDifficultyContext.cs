...
namespace osu.Game.Rulesets.Mania.Difficulty.Preprocessing
{
    ...
    public class ManiaDifficultyContext
    {
        ...
        /// <summary>
        /// Time corner data defining sampling points for difficulty calculation.
        /// Generated by <see cref="CornerPreprocessor"/>.
        /// </summary>
        ...
        /// Generated by <see cref="Density.LongNoteDensityPreprocessor"/>.
        /// </summary>
        ...
        /// Indexed by <see cref="CornerData.TimeCorners"/>.
        /// </summary>
        ...
        /// First dimension is indexed by <see cref="CornerData.TimeCorners"/>; second dimension is the key index.
        ...
        {
            double[] timePoints = CornerData.TimeCorners;

            if (timePoints.Length == 0 || values.Length == 0)
                return 0.0;

            // Clamp to boundaries
            if (time <= timePoints[0]) return values[0];
            if (time >= timePoints[^1]) return values[^1];
