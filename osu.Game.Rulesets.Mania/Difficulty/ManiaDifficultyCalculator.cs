...
namespace osu.Game.Rulesets.Mania.Difficulty
{
    public class ManiaDifficultyCalculator : DifficultyCalculator
    {
        ...
        private const double rescale_high_threshold = 9.0; // should be 9.0 in the future
        private const double rescale_high_factor = 1.2; // should be 1.0 / 1.2 in the future
