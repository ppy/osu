...
namespace osu.Game.Rulesets.Mania.Edit
{
    public class ManiaHitObjectComposer : HitObjectComposer
    {
        ...
        {
            new HitObjectCompositionTool<Note>("Note") { OnMouseDown = CreateNote },
            new HitObjectCompositionTool<HoldNote>("Hold")
            {
                OnMouseDown = CreateHoldNote,
                OnDragRequested = AdjustHoldNoteEnd
            },
        };
        ...
        public bool AdjustHoldNoteEnd(InputState state, MouseDownEventArgs args)
        {
            return true;
        }
