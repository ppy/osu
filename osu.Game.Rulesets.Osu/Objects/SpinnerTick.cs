...
namespace osu.Game.Rulesets.Osu.Objects
{
    public class SpinnerTick : OsuHitObject
    {
        ...
        public override JudgementCriteria CreateJudgement() => new OsuSpinnerTickJudgementCriteria();

        protected override HitWindows CreateHitWindows() => HitWindows.Empty;

        public override double MaximumJudgementOffset => SpinnerDuration;

        public class OsuSpinnerTickJudgementCriteria : OsuJudgementCriteria
        {
