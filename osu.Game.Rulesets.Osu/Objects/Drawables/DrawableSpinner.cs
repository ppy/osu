...
namespace osu.Game.Rulesets.Osu.Objects.Drawables
{
    public class DrawableSpinner : DrawableOsuHitObject
    {
        ...
        private bool showSpinnerSpm;
        private readonly bool notFirstSpinner;

        public DrawableSpinner(Spinner s)
            : base(s)
        {
            if (notFirstSpinner == false)
            {
                showSpinnerSpm = true;
                notFirstSpinner = true;
            }
        ...
        protected override void UpdateAfterChildren()
        {
            ...
            if (!SpmCounter.IsPresent && Disc.Tracking && showSpinnerSpm)
