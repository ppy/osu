...
namespace osu.Game.Rulesets.Osu.Objects.Drawables
{
    public partial class DrawableSpinner : DrawableOsuHitObject
    {
        ...
        protected override Judgement CreateResult(JudgementInfo judgementInfo) => new OsuSpinnerJudgement(HitObject, judgementInfo);
        ...
        protected override void CheckForResult(bool userTriggered, double timeOffset)
        {
            ...
            ApplyResult(r =>
            {
                if (Progress >= 1)
                    ...
                    r.Type = r.JudgementInfo.MinResult;
            });
        }
        ...
        private static readonly int score_per_tick = new OsuScoreProcessor().GetBaseScoreForResult(new SpinnerBonusTick.OsuSpinnerBonusTickJudgementInfo().MaxResult);
