    ...
    public class DrawableSlider : DrawableOsuHitObject, IDrawableHitObjectWithProxiedApproach
    {
        ...
        public DrawableSlider(Slider s) : base(s)
        {
            ...
            foreach (var tick in s.NestedHitObjects.OfType<SliderTick>())
            {
                ...
                var fadeInTime = repeatStartTime + (tick.StartTime - repeatStartTime) / 2 - (tick.RepeatIndex == 0 ? TimeFadein : TimeFadein / 2);
            ...
            foreach (var repeatPoint in s.NestedHitObjects.OfType<RepeatPoint>())
            {
                ...
                var fadeInTime = repeatStartTime + (repeatPoint.StartTime - repeatStartTime) / 2 - (repeatPoint.RepeatIndex == 0 ? TimeFadein : TimeFadein / 2);
                var fadeOutTime = repeatStartTime + repeatDuration;
