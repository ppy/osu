...
namespace osu.Game.Rulesets.Osu.Objects.Drawables
{
    public abstract partial class DrawableOsuHitObject : DrawableHitObject<OsuHitObject>
    {
        ...
        /// </summary>
        public void HitForcefully() => ApplyResult(r => r.Type = r.JudgementInfo.MaxResult);

        /// <summary>
        /// Causes this <see cref="DrawableOsuHitObject"/> to get missed, disregarding all conditions in implementations of <see cref="DrawableHitObject.CheckForResult"/>.
        /// </summary>
        public void MissForcefully() => ApplyResult(r => r.Type = r.JudgementInfo.MinResult);
        ...
        protected override Judgement CreateResult(JudgementInfo judgementInfo) => new OsuJudgement(HitObject, judgementInfo);
    }
}
