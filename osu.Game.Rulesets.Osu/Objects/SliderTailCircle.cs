...
namespace osu.Game.Rulesets.Osu.Objects
{
    public class SliderTailCircle : SliderEndCircle
    {
        ...
        public override JudgementInfo CreateJudgement() => ClassicSliderBehaviour ? new LegacyTailJudgementInfo() : new TailJudgementInfo();

        public class LegacyTailJudgementInfo : OsuJudgementInfo
        {
            public override HitResult MaxResult => HitResult.SmallTickHit;
        }

        public class TailJudgementInfo : SliderEndJudgementInfo
        {
