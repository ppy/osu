...
namespace osu.Game.Rulesets.Osu.Scoring
{
    public class OsuLegacyScoreProcessor : ILegacyScoreProcessor
    {
        ...
        {
            difficultyMultiplier = LegacyRulesetExtensions.CalculateDifficultyPeppyStars(beatmap);
        }

        public void ApplyMods(IReadOnlyList<Mod> mods)
        {
            modMultuplier = OsuLegacyScoreSimulator.GetOsuLegacyScoreMultiplier(mods);
        }
