...
namespace osu.Game.Rulesets.Osu
{
    public class OsuInputManager : RulesetInputManager<OsuAction>
    {
        ...
        protected override RulesetKeyBindingContainer CreateKeyBindingContainer(RulesetInfo ruleset, int variant, SimultaneousBindingMode all)
            => new OsuKeyBindingContainer(ruleset, variant, all);
        ...
        private class OsuKeyBindingContainer : RulesetKeyBindingContainer
        {
            ...
            public OsuKeyBindingContainer(RulesetInfo ruleset, int variant, SimultaneousBindingMode all)
                : base(ruleset, variant, all)
            {
            }
