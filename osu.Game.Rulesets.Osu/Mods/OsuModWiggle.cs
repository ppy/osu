...
namespace osu.Game.Rulesets.Osu.Mods
{
    internal class OsuModWiggle : ModWithVisibilityAdjustment
    {
        ...
        public override LocalisableString Description => WiggleModStrings.Description;
        ...
        [SettingSource(typeof(WiggleModStrings), nameof(WiggleModStrings.Strength), nameof(WiggleModStrings.StrengthDescription))]
