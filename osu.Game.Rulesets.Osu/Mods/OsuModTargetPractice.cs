...
namespace osu.Game.Rulesets.Osu.Mods
{
                                        ...
                                        IApplicableToHealthProcessor, IApplicableToDifficulty, IApplicableFailOverride, IHasSeed, IHidesApproachCircles
    {
        ...
        public override LocalisableString Description => TargetPracticeModStrings.Description;
        ...
        [SettingSource(typeof(TargetPracticeModStrings), nameof(TargetPracticeModStrings.Seed), nameof(TargetPracticeModStrings.SeedDescription),
            SettingControlType = typeof(SettingsNumberBox))]
        public Bindable<int?> Seed { get; } = new Bindable<int?>();

        [SettingSource(typeof(TargetPracticeModStrings), nameof(TargetPracticeModStrings.Metronome), nameof(TargetPracticeModStrings.MetronomeDescription))]
