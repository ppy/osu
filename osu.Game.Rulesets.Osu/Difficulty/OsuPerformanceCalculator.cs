    ...
    public class OsuPerformanceCalculator : PerformanceCalculator
    {
        ...
        public override double Calculate(Dictionary<string, double> categoryRatings = null)
        {
            ...
            double dummyValue =
                Math.Pow(
                    ...
                    Math.Pow(dummySpeedValue(), 1.1f) +
                    Math.Pow(dummyAccuracyValue(), 1.1f), 1.0f / 1.1f
                ) * multiplier;
        ...
        private double computeAimValue()
        {
            ...
            if (mods.Any(m => m is OsuModTouchDevice))
                rawAim = Math.Pow(Attributes.TouchAimStrain, 0.84);
        ...
        private double computeSpeedValue()
        {
            ...
            if (mods.Any(m => m is OsuModTouchDevice))
                rawSpeed = Math.Pow(Attributes.TouchSpeedStrain, 0.925);
        ...
        private double dummySpeedValue()
        {
            double rawSpeed = Attributes.SpeedStrain;
        ...
        private double dummyAccuracyValue()
        {
            // This percentage only considers HitCircles of any value - in this part of the calculation we focus on hitting the timing hit window
            double betterAccuracyPercentage;
            int amountHitObjectsWithAccuracy = countHitCircles;
