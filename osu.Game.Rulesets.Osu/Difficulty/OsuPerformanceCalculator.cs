    ...
    public class OsuPerformanceCalculator : PerformanceCalculator
    {
        ...
        private double computeAimValue(Dictionary<string, double> categoryRatings = null)
        {
            ...
            if (effectiveMissCount > 0)
                aimValue *= Math.Pow(1 - Math.Pow(comboBasedMissCount / totalHits, 0.775), effectiveMissCount);
        ...
        private double computeSpeedValue(Dictionary<string, double> categoryRatings = null)
        {
            ...
            // Penalize misses by assessing # of misses relative to the total # of objects.
            if (effectiveMissCount > 0)
                speedValue *= Math.Pow(1 - Math.Pow(comboBasedMissCount / totalHits, 0.775), effectiveMissCount);
