...
namespace osu.Game.Rulesets.Osu.Difficulty
{
    public class OsuPerformanceCalculator : PerformanceCalculator
    {
        ...
        protected override double Calculate(DifficultyAttributes difficultyAttributes, Dictionary<string, double> categoryRatings = null)
        {
            OsuDifficultyAttributes attributes = (OsuDifficultyAttributes)difficultyAttributes;
            ...
            double aimValue = computeAimValue(attributes);
            double speedValue = computeSpeedValue(attributes);
            double accuracyValue = computeAccuracyValue(attributes);
            double totalValue =
                Math.Pow(
        ...
        private double computeAimValue(OsuDifficultyAttributes attributes)
        {
        ...
        private double computeSpeedValue(OsuDifficultyAttributes attributes)
        {
        ...
        private double computeAccuracyValue(OsuDifficultyAttributes attributes)
        {
