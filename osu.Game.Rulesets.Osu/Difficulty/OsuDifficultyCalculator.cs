...
namespace osu.Game.Rulesets.Osu.Difficulty
{
    ...
    {
        private const double performance_base_multiplier = 1.145; // This is being adjusted to keep the final pp value scaled around what it used to be when changing things.
