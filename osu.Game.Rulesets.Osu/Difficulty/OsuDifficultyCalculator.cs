...
namespace osu.Game.Rulesets.Osu.Difficulty
{
    public class OsuDifficultyCalculator : DifficultyCalculator
    {
        ...
        protected override DifficultyAttributes CreateDifficultyAttributes(IBeatmap beatmap, Mod[] mods, Skill[] skills, double clockRate)
        {
            ...
            {
                hiddenRating = Math.Sqrt(skills[modIndex].DifficultyValue()) * DIFFICULTY_MULTIPLIER;
            ...
            {
                flashlightRating = Math.Sqrt(skills[modIndex].DifficultyValue()) * DIFFICULTY_MULTIPLIER;
            ...
            // Cognition
            double baseFlashlightARPerformance = baseFlashlightPerformance;
