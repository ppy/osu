...
namespace osu.Game.Rulesets.Osu.Difficulty.Utils.Interpolation
{
    ...
    public class BicubicInterpolator
    {
        ...
        /// </param>
        /// <param name="dyLower">
        /// The value of the partial derivative over <c>y</c> for all points with the smallest <c>y</c> coordinate value on the 2D grid.
        /// If missing, will be calculated separately for each edge point on the grid.
        /// </param>
        /// <param name="dyUpper">
        /// The value of the partial derivative over <c>y</c> for all points with the largest <c>y</c> coordinate value on the 2D grid.
        /// If missing, will be calculated separately for each edge point on the grid.
        /// </param>
